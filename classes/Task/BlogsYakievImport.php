 ...
 */
class Task_BlogsYakievImport extends Minion_Task
{
...
//    CONST ONE_STEP_AMOUNT = 1;
    ...
    protected function _execute(Array $params){
        ...
        $photo_path = $_SERVER['DOCUMENT_ROOT'] . '/temp/blogs/';

        /**
         * Loading categories
         */
        $source_categories = array();
        $result = DB::select()->from('blogs_section')->order_by('record_id', 'ASC')->as_assoc()->execute();
